package com.affinity.pokedex.fragments
...
import com.affinity.pokedex.activity.PokemonActivity
import com.affinity.pokedex.databinding.FragmentAboutBinding
...
class AboutFragment : Fragment() {
    ...
    private fun setAllData(pokemon: Pokemon, mainColor: String) {
        binding.apply {
            ...
            tvCatchRate.text = pokemon.capture_rate
        }
    }
    ...
    private fun getAbilities(pokemon: Pokemon) : String{
        ...
        if(pokemon.abilities_hidden.isNotEmpty())
